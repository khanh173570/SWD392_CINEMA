...
import { Users, UserCheck, UserX, Settings, Activity, Bell } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-yellow-500 to-amber-600 rounded-lg shadow-md p-6 text-white">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-medium opacity-80">New Registrations</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600">JD</div>
                      <div className="ml-4">
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600">AS</div>
                      <div className="ml-4">
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-red-100 flex items-center justify-center text-red-600">RJ</div>
                      <div className="ml-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="text-blue-600 hover:text-blue-800">Mark All Read</button>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-3 bg-blue-50 rounded-lg border border-blue-100">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">New version deployed successfully.</p>
            ...
            <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-100">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-800">New Registration</p>
                  <p className="text-xs text-gray-500 mt-1">10 new users registered today.</p>
            ...
            <div className="p-3 bg-red-50 rounded-lg border border-red-100">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Multiple failed login attempts detected.</p>
            ...
            <div className="p-3 bg-green-50 rounded-lg border border-green-100">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Email notification settings were updated.</p>
